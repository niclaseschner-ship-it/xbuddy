...
Symbol: echtes ARASAAC-Kalender-Piktogramm (ID 32488 — "Kalender", core vocabulary).

Quell-Piktogramm:
  https://api.arasaac.org/api/pictograms/de/search/kalender  → _id 32488
  https://static.arasaac.org/pictograms/32488/32488_500.png
...
Vorgehen:
  ...
  4. Fuer maskable-512: kleineres Padding (Symbol darf bis ~5% an den Rand).
...
# ARASAAC-Kalender-Piktogramm (ID 32488 — "Kalender", schematisch, core vocabulary)
ARASAAC_ID = 32488
...
def _lade_arasaac_png():
    """Laedt das ARASAAC-Kalender-Piktogramm als RGBA-Image.
...
if __name__ == "__main__":
    ...
    print(f"Generiere plan-einstellungen-PWA-Icons (PLAN-35) aus ARASAAC-Piktogramm {ARASAAC_ID}…")
