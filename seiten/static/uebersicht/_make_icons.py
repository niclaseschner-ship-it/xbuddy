#!/usr/bin/env python3
"""_make_icons.py — PWA-Pflicht-Icons für die Übersicht (#1940).

192/512/maskable-512 (PWAM-2). Brand: Sand-BG (#F5F1E8), wie routine/plan.
Symbol: ARASAAC 2317 ("Haus") — die Übersicht ist das Zuhause aller xbuddy-Seiten.

Lauf:  python3 seiten/static/uebersicht/_make_icons.py
"""
...
if __name__ == "__main__":
    ...
    print(f"Generiere Übersicht-PWA-Icons (#1940) aus ARASAAC {ARASAAC_ID}…")
    try:
