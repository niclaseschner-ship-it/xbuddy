...
Alle 7b-Routen laufen ab T1426 im Hard-Modus.  Die bestehenden Seiten-Tests
...
Testclient, der ueber seiten_main.app.test_client() erzeugt wird — ohne jede
...
_OPERATOR_ENVIRON = {"HTTP_X_REAL_IP": "192.168.178.42"}


@pytest.fixture(autouse=True)
def inject_operator_ip(monkeypatch):
    """Injiziert Operator-IP in alle ueber seiten_main.app.test_client() erzeugten Clients."""
    original_test_client = seiten_main.app.test_client.__func__
    ...
    monkeypatch.setattr(seiten_main.app.__class__, "test_client", patched_test_client)
