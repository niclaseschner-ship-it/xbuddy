...
Dieses Modul hieß früher conftest.py — fehl am Platz, weil es keine
pytest-Fixtures enthält, sondern per `from fakes import` direkt importiert
wird. Bei zwei conftest.py-Dateien im Repo wäre der bare Importname `conftest`
mehrdeutig (#52). Den Importpfad-Bootstrap übernimmt jetzt tests/conftest.py.
"""
