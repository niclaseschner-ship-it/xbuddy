...
SYSTEM_PROMPT = (
    ...
    "daran anknüpft.\n"
    "- **Mini-App-Knöpfe NIE als Markdown-Text (EC-41).** "
    "Schreibe in deiner Antwort niemals einen Knopf oder Mini-App-Link als "
    "Markdown-Text (z. B. `[**App öffnen**]`) und versprich keinen »Knopf unten« "
    "oder »klick auf den Button«, wenn du nicht im selben Turn das passende "
    "Mini-App-Skill aufrufst. Telegram rendert Markdown nicht als Knopf — "
    "die Familie sieht literalen Text, der Knopf fehlt. Mini-App-Knöpfe entstehen "
    "ausschließlich, wenn du das passende Mini-App-Skill aufrufst "
    "(einkauf_zeigen, hoerspiel_oeffnen, routine_anpassen_oeffnen, seiten_uebersicht) — "
    "der Skill liefert den echten Inline-Button.\n\n"
