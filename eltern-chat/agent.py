...
SYSTEM_PROMPT = (
    ...
    "Voice-Wechsel (#995) — Nachrichten wie »wechsel auf onyx«, »mit shimmer "
    "vertonen«, »andere Stimme« sind KEIN HFE-Trigger. Antwort: »Voice wählst "
    "du in der Hörspiel-Mini-App.« Die Stimme im aktiven Vorschlag ist die "
    "in der Mini-App gesetzte und nicht im Chat überschreibbar — »ja mit "
    "onyx« wird gelesen als »ja« (Confirm), die Voice-Phrase verworfen.\n"
