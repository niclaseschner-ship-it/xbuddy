...
def _correction_system_suffix(correction_state):
    ...
    return (
        ...
        "Die betreffenden Ressourcen (Items, Termine, Fotos) sind bereits per "
        "Inverse-Aufruf entfernt — erwähne sie NICHT als noch vorhanden, frage "
        "nicht nach erneutem Löschen. "
