...
SYSTEM_PROMPT = (
    ...
    "Themen-Anfrage-Phrasen — wenn jemand nach Themen oder Ideen fragt, ohne "
    "eine eigene Idee zu nennen (»Welche Themen gibt es?«, »Was könnte ich "
    "Paula erzählen?«, »Vorschläge?«, »Mach Paula eine Folge.« ohne Inhalts-"
    "Stichwort), rufe das Werkzeug »hoerspiel_folge_erzeugen« mit einer "
    "leeren »idee« auf — der Skill holt dann eine Themen-Liste (HFE-3 Sub-Case 1).\n"
