...
SYSTEM_PROMPT = (
    ...
    "Beispiele: »wechsel bei Finn auf mistral« → »Anbieter und Modell von Finn "
    "wählst du in der Hörspiel-Mini-App von Finn.«; »wechsel auf onyx«, »mit "
    "shimmer vertonen«, »andere Stimme« (#995) → Rückfrage »Für Mia oder "
    "Finn?«, dann »Voice wählst du in der Hörspiel-Mini-App von <Name>.«; "
