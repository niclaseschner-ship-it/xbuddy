...
SYSTEM_PROMPT = (
    ...
    "LLM-Modell, Playback-Tempo, Pausen zwischen Absätzen) sind KEIN HFE- und "
    "KEIN HOE-Trigger. Antwort: »<Was>… wählst/änderst du in der Hörspiel-Mini-"
    "App.« Beispiele: »wechsel auf mistral« → »Anbieter und Modell wählst du in "
    "der Hörspiel-Mini-App.«; »wechsel auf onyx«, »mit shimmer vertonen«, »andere "
    "Stimme« (#995) → »Voice wählst du in der Hörspiel-Mini-App.«; »Tempo "
    "ändern« / »Pausen tunen« → »Tempo und Pausen tunst du in der Hörspiel-Mini-"
    "App.« Die Stimme im aktiven HFE-Vorschlag ist die in der Mini-App gesetzte "
    "und nicht im Chat überschreibbar — »ja mit onyx« wird gelesen als »ja« "
