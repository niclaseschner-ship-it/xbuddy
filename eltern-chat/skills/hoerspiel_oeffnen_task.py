    ...
    def __init__(self, tg, hoerspiel_client, is_member_fn, mini_app_url=""):
        super().__init__(
            ...
            description=(
                ...
                "Sendet Folgen-Übersicht + Mini-App-Inline-Button auf den "
                "Folgen-Tab. Auch bei leerem Album-Bestand wird der Button gesendet. "
                "EC-40 Familien-Trigger (RATIFIZIERT 2026-06-22, Refs #1075): "
                "Der Skill feuert AUCH bei jeder Kombination aus dem "
                "Aktions-Vokabular (settings, einstellungen, anpassen, "
                "bearbeiten, ändern, öffnen, zeigen, schicken, geben, app, "
                "mini-app) und einer Hörspiel-Bezeichnung (Hörspiel, Hörbuch, "
                "Story, Folge, Geschichte) — auch ohne ein in der Folgen-Liste "
                "genanntes Verb. Beispiele: 'gib mir die Hörbuch-App', "
                "'Hörspiel öffnen', 'schick mir die Hörspiel mini-app', "
                "'Folge zeigen'. "
                ...
                "Anbieter-, Modell-, Tempo-, Pausen-Wechsel, »auf X wechseln« "
                "ohne Settings-Link-Bitte) → KEIN Tool-Call, sprachlicher "
                "Verweis (siehe System-Prompt). "
                "EC-41 Anti-Markdown-Knopf (RATIFIZIERT 2026-06-22): NIEMALS "
                "einen Mini-App-Knopf in der Antwort als Markdown-Text "
                "schreiben — der Inline-Button kommt automatisch über diesen "
                "Tool-Call. Kein '[**…**]'-Pseudo-Knopf, kein 'Klick auf den "
                "Knopf', keine Klartext-URL zur App. "
