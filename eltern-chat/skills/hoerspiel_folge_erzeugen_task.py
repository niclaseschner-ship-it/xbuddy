...
class HoerspielFolgeErzeugenTask(WriteTask):
    ...
    def __init__(self, tg, hoerspiel_client, display_url_origin: str = "",
        ...
        super().__init__(
            ...
            description=(
                ...
                "Paula eine Folge zu Y«, »Hörbuch über Z«. Plus Themen-"
                "Anfrage: »Welche Themen gibt es?«, »Was könnte ich Paula "
                "erzählen?«, »Vorschläge?«.\n\n"
    ...
    def propose(self, arguments, turn_context):
        ...
        # V1: hartkodiert "paula" — Face-Pille (#911) bringt den aktiven kind_id-State.
