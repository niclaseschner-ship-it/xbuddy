...
## Was geprüft wird (Heuristiken)
  ...
  Fixtures nie auftreten sollten:
    - E-Mail-Adressen der bekannten Familien-Domain (@example.org, real user id)
...
## Dokumentation der Gate-Entscheidungen
  ...
  - `emil_sonntag` / `@example.org`: echter User-Account aus MEMORY.md
...
FORBIDDEN_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    ("real-email-gmx", re.compile(r"emil_sonntag@gmx\.de", re.IGNORECASE)),
    # Generisches @example.org / @gmail.com — echte Adressen
