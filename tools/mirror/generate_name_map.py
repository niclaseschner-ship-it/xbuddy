...
SLUG_MAP: dict[str, str] = {
    ...
    "paula":  "kind1",
    "neko":   "kind2",
    "niclas": "kind3",  # dritte Instanz T1347
}
...
GATE1_PATTERNS = [
    ...
    r"\bpaula\b", r"\bneko\b", r"\bniclas\b",
    # Weitere Familien-Vornamen (nicht in technischen Slugs)
    r"\bsophia\b", r"\bjulian\b", r"\bvera\b", r"\btaro\b",
    # Private Mails
    r"niclas\.eschner@gmail",
    r"niclas\.eschner@gmx",
    r"niclas_eschner@gmx",
    # GitHub-Org
    r"niclaseschner-ship-it",
    # Tailscale FQDN
    r"taile235cf",
    # LAN-IP
    r"192\.168\.",
...
def discover_slugs_from_ports_md(repo_root: Path) -> list[str]:
    ...
    for line in ports_md.read_text().splitlines():
        # Zeilen wie: | 5053 | Hörspiel-Buddy (Paula) | xbuddy-hoerspiel |
