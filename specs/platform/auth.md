...
/api/v1/hoerspiel/<kind_id>/play-extern       (Trigger: Phase 4 HSP-Audio-Routing — HSP-42 SUPERSEDED §13, kein aktiver Caller)
/api/v1/hoerspiel/<kind_id>/audio-stream      (Trigger: Phase 4 HSP-Audio-Routing — HSP-42 SUPERSEDED §13; Endpoint noch aktiv: app-panel/app.js PANEL-13)
