...
- `slug` — technischer, stabiler Schlüssel (live `paula`/`neko`/`niclas`; im getrackten Example + im Public-Snapshot `kind1`/`kind2`). BUD-1 (ein stabiler Slug) bleibt gewahrt.
