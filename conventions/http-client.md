...
**Heimat:** die drei aktuellen Clients, aus denen diese Konvention extrahiert
wurde:
...
Plan-Buddy-spezifische Fallback (PLAN-20-Geist). Neue Clients aus dem
Eltern-Chat-Kontext folgen dem `<Komponente>ClientError`-Muster.
