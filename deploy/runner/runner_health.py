...
`pi5-buddy` (`actions.runner.emilsonntag-ship-it-xbuddy.pi5-buddy.service`)
...
DEFAULT_REPO = "emilsonntag-ship-it/xbuddy"
DEFAULT_SERVICE = "actions.runner.emilsonntag-ship-it-xbuddy.pi5-buddy.service"
