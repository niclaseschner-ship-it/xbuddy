...
| `xbuddy-hoerspiel.service` | `hoerspiel/hoerspiel.service` | Hörspiel-Buddy für Paula (`/display/hoerspiel/`, `/api/v1/hoerspiel/`) | `127.0.0.1:5060` |
| `xbuddy-hoerspiel-neko.service` | `hoerspiel/hoerspiel-neko.service` | Hörspiel-Buddy für Neko (`/display/hoerspiel-neko/`, `/api/v1/hoerspiel-neko/`) | `127.0.0.1:5061` |
| `xbuddy-kibuddy.service` | `kibuddy/kibuddy.service` | KI-Buddy (KIBUDDY-21, `/api/v1/kibuddy/`, OpenAI/Anthropic-LLM-Integration) | `127.0.0.1:5070` |
