...
| `xbuddy-hoerspiel.service` | `hoerspiel/hoerspiel.service` | Hörspiel-Buddy für Mia (`/display/hoerspiel/`, `/api/v1/hoerspiel/`) | `127.0.0.1:5060` |
| `xbuddy-hoerspiel-finn.service` | `hoerspiel/hoerspiel-finn.service` | Hörspiel-Buddy für Finn (`/display/hoerspiel-finn/`, `/api/v1/hoerspiel-finn/`) | `127.0.0.1:5061` |
