...
auf einem Display: Petrantwortlichkeiten, Kind-Aktivitäten und Termine.

Sie besitzt ihre Daten (Petrantwortlichkeiten in plan.db) und ihre Funktion
...
Module:
  config    — Slot-Definitionen + Default-Petrantwortlichkeiten (PLAN-6/10/28)
  db        — SQLite-Datenhaltung der Petrantwortlichkeiten (PLAN-8/9)
