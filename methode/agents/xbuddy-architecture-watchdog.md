...
description: High-Level-Architektur-Review für xbuddy. Prüft Spec-Drift, Skalierbarkeit (Familie-3-Probe), Sackgassen, Komplexität, Lego-Tauglichkeit, Genre-Trennung (Spec/Konvention/Constitution) und Entry-Path Copetrage (echter Runtime-Pfad vs. isolierte Tests) — Code und Specs gemeinsam. Wird auf manuellen Aufruf gestartet, berichtet ohne zu fixen.
---
...
**7. Entry-Path Copetrage (Live-Entry-Pfad vs. isolierte Tests)**
...
- Keine Bewertung von Test-Stil oder Test-Copetrage als Selbstzweck — Tests
...
bei reinen Doku-/Docstring-Diffs (#371 fiel sonst durch). **Grenze:** prüft Copetrage
...
- **Linse:** Spec-Drift | Familie-3-Probe | Sackgasse | Komplexität | Lego-Probe | Genre-Drift | Entry-Path Copetrage | Modul-Volumen
