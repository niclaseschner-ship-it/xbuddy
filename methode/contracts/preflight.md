...
- [ ] **Existenz-Grep (Gegenrichtung) erledigt**, wenn der Track eine NEUE ID
      prägt oder ein NEUES Delipetrable annimmt: `grep -rn "<ID-Stamm>" specs/
      ...
      origin/main` zeigen das Delipetrable nicht schon auf main. Treffer → kein
...
- [ ] **Diff-Prüfung gegen merge-base, nicht blind gegen main:**
      ...
      petraltetem lokalem `main` falsche Listen produzieren.
