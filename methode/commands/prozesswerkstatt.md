...
Repo **`emilsonntag-ship-it/xbuddy-prozess`** (Prozess-Tickets, **strikt
...
```bash
gh issue list -R emilsonntag-ship-it/xbuddy-prozess --state open   # erst dedup-Check
gh issue create -R emilsonntag-ship-it/xbuddy-prozess \
