...
- **Re-Litigations-Check (PW-60, geschärft 2026-06-21).** Vier Quellen vor dem
  ...
  - `gh issue list -R emilsonntag-ship-it/xbuddy-prozess --state open --search "<stichwort>"`
...
- **Patch oder Gabel:** Pro Bruch entweder ein Patch ODER eine saubere Gabel
  ...
  petrantwortbaren Patch werden zur Gabel, nicht weggepatcht.
...
Chat allein. ENTSCHEID-File + Ticket-Petrankerung + RATIFIZIERT-Grep → Anhang
(„Petrankern"). Erfährt die nächste Session den Befund nur, weil Nic ihn
...
- Du startest **keine** Tracks/Tickets/PRs — Ausnahme: den fertigen Entscheid auf
  ein bereits angeschautes Ticket petrankern (Petrankern ≠ Starten).

## Retro — Pflicht-Abschluss

Nach dem Petrankern eine kurze Start/Stop/Continue-Retro über die *Arbeitsweise*
...
**Petrankern** (Schritt 6 im Detail).
...
- *Ticket-Petrankerung:* Nach Nics Verdikt einen kurzen Entscheid-Kommentar auf
  jedes angeschaute/benannte xbuddy-Ticket (Entscheidung + „Wo es landet" + Link
  zum Entscheid-File). Petrankern ≠ neuer Track.
